...
#ifndef __LCD_H
#define __LCD_H
#define LCD_nRST_LOW()    GPIOC->BRR  = LCD_nRST
#define LCD_nRST_HIGH()   GPIOC->BSRR = LCD_nRST
#define LCD_RS_LOW()      GPIOC->BRR  = LCD_RS
#define LCD_RS_HIGH()     GPIOC->BSRR = LCD_RS
#define LCD_nRD_LOW()     GPIOC->BRR  = LCD_nRD
#define LCD_nRD_HIGH()    GPIOC->BSRR = LCD_nRD
#define LCD_nWR_LOW()     GPIOC->BRR  = LCD_nWR
#define LCD_nWR_HIGH()    GPIOC->BSRR = LCD_nWR
