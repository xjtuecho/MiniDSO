...
enum{               //第一页子菜单选项
  CH1_Vol,  CH1_Posi, CH1_Coupl, CH1_Enable,CH1_Fit,
  CH2_Vol,  CH2_Posi, CH2_Coupl, CH2_Enable,CH2_Fit, 
...
enum{             //第三页之菜单选项
  SAVE_Pam,   SAVE_Bmp,    SAVE_Dat,   SAVE_Buf,  SAVE_Csv,  LOAD_Dat,  LOAD_Buf,
  WAVE_Type,  WAVE_Freq,   WAVE_Duty,
  SYS_Volume, SYS_BKLight, SYS_Standy, SYS_PowerOff, SYS_MenuCyc, SYS_ItemCyc,SYS_PosiSlide, 
};

enum{
  SAVE_PAM = 1,   SAVE_BMP,    SAVE_DAT,   SAVE_BUF,  SAVE_CSV,  LOAD_DAT,  LOAD_BUT,
};
