...
APP v1.27: 修改了ADC校准参数，修正了衰减10倍时计算值显示错误问题。
...
APP v1.27: Modified the ADC calibration parameters, and corrected the display error of the calculated value when the attenuation is 10 times.